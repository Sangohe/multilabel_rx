...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
# Class names and paths to record and model path (if evaluating)
...
network_1 = EasyDict(freeze=True, weights_path=None, input_shape=(224, 224, 3), n_classes=len(class_names), model_name='frontal')
...
desc += '-rx_chexpert_f';             dataset = EasyDict(batch_size=32, shuffle=1024, prefetch=10);    dataset.map_functions = []
...
# train = EasyDict(func='util_scripts.generate_cams', model_path="", run_id=10, image_path="/data/DeepSARS/datasets/chexpert-tm/images/valid/patient64548/study1/view1_frontal.jpg", scale_func="dataset.scale_imagenet_np", class_names=class_names)